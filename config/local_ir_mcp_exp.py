ENDPOINT_MODULE = 'very_very_very_very_very_very_special_module_name'
#########################################################################
...
def very_very_very_very_very_very_special_device_controller(cmd: str) -> dict:
    """
    instructions动态插入
    """
...
very_very_very_very_very_very_special_device_controller.__doc__ = device_instructions if device_instructions else '用户未配置MCP控制说明'
mcp.add_tool(very_very_very_very_very_very_special_device_controller)
