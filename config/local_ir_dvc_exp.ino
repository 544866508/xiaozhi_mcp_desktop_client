...
// ========== 文件开头，自定义路径名，修改这里即可 ==========
const String controllerPath = "very_very_very_very_very_very_special_controllerPath";
const String apName = "very_very_very_very_very_very_special_apName";
// ========================================================


// ======================== 【1. 基础单条红外指令】 ========================
struct RawCommand {const char* cmdName; std::vector<uint16_t> rawData;};
const std::vector<RawCommand> rawCmdList = very_very_very_very_very_very_special_rawCmdList;
...
const std::vector<SequenceCommand> seqCmdList = very_very_very_very_very_very_special_seqCmdList;
// ==============================================================================
