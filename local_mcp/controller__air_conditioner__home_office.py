ENDPOINT_MODULE = 'local_mcp.controller__air_conditioner__home_office'
#########################################################################
...
def controller__air_conditioner__home_office(cmd: str) -> dict:
    """
    instructions动态插入
    """
...
controller__air_conditioner__home_office.__doc__ = device_instructions if device_instructions else '用户未配置MCP控制说明'
mcp.add_tool(controller__air_conditioner__home_office)
