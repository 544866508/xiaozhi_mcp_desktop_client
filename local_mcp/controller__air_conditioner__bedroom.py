ENDPOINT_MODULE = 'local_mcp.controller__air_conditioner__bedroom'
#########################################################################
...
def controller__air_conditioner__bedroom(cmd: str) -> dict:
    """
    instructions动态插入
    """
...
controller__air_conditioner__bedroom.__doc__ = device_instructions if device_instructions else '用户未配置MCP控制说明'
mcp.add_tool(controller__air_conditioner__bedroom)
